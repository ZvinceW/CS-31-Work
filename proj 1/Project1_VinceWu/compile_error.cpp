...
int main()
{
	...
	cout >> "How many registered voters were surveyed? ";   //changed "<<" to ">>", violating the syntax
	cin >> numberSurveyed;
	cout << "How many of them say they will vote for Hillary? ";
	cin >> forHillary;
	cout << "How many of them say they will vote for Donald? " //did not include a semi-colon at the end of this line
	cin >> forDonald;
